/// \file wrap_stdint.h
/// \brief wrapper for integer types to help porting between nix and windows
...
typedef uint64_t volatile  v_uint64_t;
typedef uint64_t volatile * p_v_uint64_t;
