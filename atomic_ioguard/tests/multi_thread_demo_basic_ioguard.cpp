/// \file multi_thread_demo_basic_ioguard.cpp
...
IOGuard<record> guarded_records[NUMBER_RECORDS];
...
struct writer {
  ...
  void operator()() {
    ...
    while (!stop_) {
      ...
      r.randomize();
      IOGuard<record>::copy_to_rhs( r, &guarded_records[offset]);
    }
  }
};
...
/// \mainpage
/// The template class <a href="basic__ioguard_8h_source.html">basic_ioguard</a> 
...
///   </li>
///   </ul>
///  <p> The program <a href="multi__thread__demo__basic__ioguard_8cpp_source.html"> multi_thread_demo_basic_io.cpp </a> is a both simple use case, and regression test. </p>
